...
export default function HomePage() {
  return (
    <div className="relative min-h-svh overflow-hidden">
      ...
      <main className="relative z-10 mx-auto flex w-full max-w-5xl flex-col gap-16 md:py-24">
        ...
        <section className="grid gap-4 md:grid-cols-3">
          {[
            ...
            <div key={item.title} className="rounded-2xl border bg-card/80 p-5 shadow-xs backdrop-blur">
